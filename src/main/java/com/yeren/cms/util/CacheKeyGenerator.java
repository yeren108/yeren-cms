package com.yeren.cms.util;

import com.yeren.cms.controller.CategoryController;
...
class CacheKeyGenerator implements KeyGenerator {
    ...
    public Object generate(Object target, Method method, Object... params) {
        ...
        long cacheKeyHash = Hashing.MD5.hash(finalKey);
       // long cacheKeyHash = Hashing.MURMUR_HASH.hashString(finalKey, Charset.defaultCharset()).asLong();
