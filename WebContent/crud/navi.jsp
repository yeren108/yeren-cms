...
<nav class="navbar navbar-default navbar-top" role="navigation">
   ...
   <div style="padding: 10px 23px;font-size: 24px;">
      <ul id="WWW" class="nav navbar-nav">
         <li id="btn1" ><a href="${pageContext.request.contextPath}/crud/site/siteList.jsp">站点</a></li>
         <li id="btn2"><a href="${pageContext.request.contextPath}/crud/category/categoryList.jsp">栏目</a></li>
         <li id="btn3"><a href="${pageContext.request.contextPath}/crud/article/articleList.jsp">标题</a></li>
         <li id="btn4"><a href="${pageContext.request.contextPath}/crud/link/linkList.jsp">链接</a></li>
         <li id="btn5" class="dropdown">
            <a href="${pageContext.request.contextPath}/common/404.jsp" class="dropdown-toggle" data-toggle="dropdown">
               	备用<b class="caret"></b>
            </a>
            <ul class="dropdown-menu">
               <li><a href="${pageContext.request.contextPath}/common/404.jsp">子备用1</a></li>
               <li><a href="${pageContext.request.contextPath}/common/404.jsp">子备用2</a></li>
               <li><a href="${pageContext.request.contextPath}/common/404.jsp">子备用3</a></li>
               <li class="divider"></li>
               <li><a href="${pageContext.request.contextPath}/common/404.jsp">子备用4</a></li>
               <li class="divider"></li>
               <li><a href="${pageContext.request.contextPath}/common/404.jsp">子备用5</a></li>
            </ul>
         </li>
         <li id="btn6"><a href="${pageContext.request.contextPath}/common/404.jsp">其他</a></li>
      </ul>
   </div>
</nav>
